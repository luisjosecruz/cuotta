...
function handlePost ($post, $conn, $token) {
    ...
    if (isAVT($idTransaccion, $token)) {
        $query = "
            INSERT INTO abonos(
                movID, abonoCtaID, abonoCorr, abonoFecha, abonoHora, abonoSucursal, abonoBruto, mandCorrelativo, abonoUsuario, abonoData
            ) VALUES (
                '101-02', '101', '$idTransaccion', '$fechaTrans', '$horaTrans', '$nombreAplicativo', $monto, '$mandamiento', 'admin1', '$json'
            )
        ";
