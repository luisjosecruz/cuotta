...
function startPages(){
    ...
    let data = { community: community.val(), month: month.val(), background: bg, urlserver: urlserver};
    
    $.ajax({
        type: "POST",
        url: "<?=$URLSERVER?>ajax/getPagesv2.php",
        data: data,
        beforeSend: function(){
            $(".pages").html("");
        },
