        ...
        <article class="luismartbox">
            <section class="luismartbox-body">
                <div class="luismartbox-img">
                    <img src="<?=$URLSERVER?>assets/images/login.svg" alt="">
                </div>
                <div class="luismartbox-login">
                    ...
                    <form id="login-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" value="<?=$URLSERVER?>" id="server">
                        </div>
                    </form>
                </div>
            </section>
            <!-- <section class="luismartbox-header">
                <h1>WELCOME TO CUOTTA</h1>
                <p>What I can do for you?</p>
            </section>
            <section class="luismartbox-menu">
                <ul>
                    <li><a href="<?=$URLSERVER?>print">Estados de cuenta para imprimir v2</a></li>
                    <li><a href="<?=$URLSERVER?>printv1">Ver las facturas para imprimir versión 1</a></li>
                    <li><a href="<?=$URLSERVER?>barcode">Generar código de barras</a></li>
                    <li><a href="<?=$URLSERVER?>mandamientos">Estados de cuenta por mandamientos</a></li>
                </ul>
            </section> -->
        </article>
    </main>
